...
if (!ext) {
  ext = seal.ext.new('万物有灵·万象篇', '铭茗', '3.2.2');
...
function init() {
  ...
  // 注册Mod
  main.registerMod({ id: 'wanwu-all', name: '万物有灵-扩展合集', version: '3.2.2', author: '铭茗', description: '图鉴、探险、打工、竞技场、成就、装备、技能书、市场、季节活动', dependencies: [] });
